    ...
    <section className="relative overflow-hidden bg-black py-24 text-gray-50">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          >
            <h2 className="text-2xl font-semibold text-white">How Alphabera Global helps in {locationLabel}</h2>
          ...
          >
            <div className="flex items-center gap-3 text-white">
              ...
              <h2 className="text-xl font-semibold">Local search intent</h2>
            </div>
            <p className="mt-4 leading-7 text-gray-300">
              People often search for terms like <span className="text-brand-300">{seoLabel}</span>. This page exists to
              explain your services clearly for those local searches in a helpful, user-first way.
            </p>
            ...
            <div className="mt-8 rounded-2xl border border-brand-500/20 bg-brand-500/10 p-5">
              ...
              <p className="mt-3 text-sm leading-6 text-gray-300">
                If you want more local reach, your website, service pages, Google Business Profile, and reviews should all
                tell the same story about your business and service area.
              </p>
              <a
                href="/#contact"
